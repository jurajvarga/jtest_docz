...
{
  "id" : "BA_CreateSkuToUKCatalogReference",
  "type" : "BusinessAction",
  "setupGroups" : [ "Migration Business Actions" ],
  "name" : "BA_CreateSkuToUKCatalogReference",
  "description" : "Create SKU to catalog classification for UK catalogs.",
  "scope" : "Global",
...
/**
script ID: BA_CreateSkuToUKCatalogReference
description: Create SKU to catalog classification for UK catalogs.
...
var businessRule = "Business Rule: BA_CreateSkuToUKCatalogReference"
var currentObjectID = "Current Object ID: " + currentObject.getID();

// UK Catalogs (object type: Catalog Region)
var class_home_id = "UK000001";
