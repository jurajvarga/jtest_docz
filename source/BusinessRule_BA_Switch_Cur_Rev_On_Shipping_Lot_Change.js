...
{
  "id" : "BA_Switch_Cur_Rev_On_Shipping_Lot_Change",
  "type" : "BusinessAction",
  "setupGroups" : [ "Inbound_Business_Rules" ],
  "name" : "BA_Switch_Cur_Rev_On_Shipping_Lot_Change",
  "description" : null,
  "scope" : "Global",
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "alias" : "BA_Set_Revision_Release_Status",
    "parameterClass" : "com.stibo.core.domain.impl.businessrule.FrontBusinessActionImpl",
    "value" : "BA_Set_Revision_Release_Status",
    "description" : null
  }, {
    "contract" : "BusinessActionBindContract",
    "alias" : "BA_Update_Child_Species_Homology",
    "parameterClass" : "com.stibo.core.domain.impl.businessrule.FrontBusinessActionImpl",
    "value" : "BA_Update_Child_Species_Homology",
    "description" : null
  }, {
    "contract" : "BusinessActionBindContract",
    "alias" : "BA_SetCurrentRevRelease",
    "parameterClass" : "com.stibo.core.domain.impl.businessrule.FrontBusinessActionImpl",
...
*/
exports.operation0 = function (manager,node,BA_Set_Revision_Release_Status,BA_Update_Child_Species_Homology,BA_SetCurrentRevRelease,productQueue,webCategoryQueue,currentRevisionUpdated,BA_Approve,noShippingLotMsgQueue,noShippingLotMsgEvent,BL_Library,BL_MaintenanceWorkflows) {
var productno = node.getValue("PRODUCTNO").getValue();
var shippingLotNo = node.getValue("Shipping_Lot_No").getValue();
//var shippingLotNo = "30";
        ...
        if (curRev) {
            ...
            if (bCurrentRevHasShippingLot) {
                ...
                if (highestRevWithShippingLot) {
                    // If there is a revision in Rev Release Workflow with the shipping lot, make the highest one of them as current
