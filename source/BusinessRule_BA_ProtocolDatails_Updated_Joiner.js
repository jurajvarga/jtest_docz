...
{
  "id" : "BA_ProtocolDatails_Updated_Joiner",
  "type" : "BusinessAction",
  "setupGroups" : [ "Outbound_ProtocolDatails_Updated" ],
  "name" : "BA_ProtocolDetails_Updated_Joiner",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
joinerResult = BL_Joiner.join(joinerSource, joinerResult, "upsert", "Application Protocols");
}