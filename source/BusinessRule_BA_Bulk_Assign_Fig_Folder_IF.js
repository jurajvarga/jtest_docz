...
{
  "id" : "BA_Bulk_Assign_Fig_Folder_IF",
  "type" : "BusinessAction",
  "setupGroups" : [ "Bulk_Assign_WF4_App_Mgr_PC_Review" ],
  "name" : "BA Bulk Assign Figure Folder IF",
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "alias" : "IF_Team_Assignee",
    "parameterClass" : "com.stibo.core.domain.businessrule.attributecontextparameter.AttributeValidatedContextParameter",
    "value" : "<AttributeValidatedContextParameter>\n  <Parameters>\n    <Parameter ID=\"Attribute\" Type=\"java.lang.String\">IF_Team_Assignee</Parameter>\n    <Parameter ID=\"ID\" Type=\"java.lang.String\">IF_Team_Assignee</Parameter>\n  </Parameters>\n</AttributeValidatedContextParameter>",
    "description" : null
  }, {
...
*/
exports.operation0 = function (IF_Team_Assignee,node,manager,auditEventType,auditQueueMain,auditQueueApproved,BL_AuditUtil,BL_Library,BL_MaintenanceWorkflows,BL_WorkflowUtil) {
var wfID = "WF4_App_Mgr_PC_Review_Workflow";
var stateID = "App_Manager";
var userID = IF_Team_Assignee;
