...
{
  "id" : "BA_CreateSkuToDECatalogReference",
  "type" : "BusinessAction",
  "setupGroups" : [ "Migration Business Actions" ],
  "name" : "BA_CreateSkuToDECatalogReference",
  "description" : "Create SKU to catalog classification for Germany/Austria catalogs.",
  "scope" : "Global",
...
/**
script ID: BA_CreateSkuToDECatalogReference
description: Create SKU to catalog reference for Germany/Austria catalogs.
...
var businessRule = "Business Rule: BA_CreateSkuToDECatalogReference"
var currentObjectID = "Current Object ID: " + currentObject.getID();

// Germany Catalogs (object type: Catalog Customer)
var class_home_id = "DE_Catalogs";
