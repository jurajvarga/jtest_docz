...
{
  "id" : "BA_CreateSkuToROWCatalogReference",
  "type" : "BusinessAction",
  "setupGroups" : [ "Migration Business Actions" ],
  "name" : "BA_CreateSkuToROWCatalogReference",
  "description" : "Create SKU to catalog classification for China catalogs.",
  "scope" : "Global",
...
/**
script ID: BA_CreateSkuToROWCatalogReference
description: Create SKU to catalog classification for ROW catalogs.
...
var businessRule = "Business Rule: BA_CreateSkuToROWCatalogReference"
var currentObjectID = "Current Object ID: " + currentObject.getID();

// ROW Catalogs (object type: Catalog Region)
var class_home_id = "CSUPR3538189";
