...
{
  "id" : "BA_Init_Maintain_EU_DG_GTL_Review",
  "type" : "BusinessAction",
  "setupGroups" : [ "Product_Maintenance" ],
  "name" : "BA_Init_Maintain_EU_DG_GTL_Review",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
//STEP-5817
var maintenanceWFNo = "16A2";
var region = "EU";
var ret = BL_MaintenanceWorkflows.createRegionalRevisionRequest_DG(manager, node, maintenanceWFNo, region, lookUp);
...
/* old way if reg maintenance
var maintenanceWFNo = "16A2";
var region = "EU";
var ret = BL_MaintenanceWorkflows.initiateMaintenanceDGWF(manager, node, maintenanceWFNo, region, lookUp,"U");
