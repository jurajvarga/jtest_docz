...
{
  "id" : "BA_WFClassifyAsset",
  "type" : "BusinessAction",
  "setupGroups" : [ "AssetBusinessActions" ],
  "name" : "BA_WFClassifyAsset",
  "description" : "WF-7B ",
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
var businessRule = "Business Rule: BA_GeneratePSDFileName";
var currentDate = "Date: " + (new Date()).toLocaleString();

var parentClassID = "ProductStatusChangeRoot";
var referenceType = manager.getReferenceTypeHome().getReferenceTypeByID("Product_Status_Change_Documents");
...
if (!assetReferenceList.isEmpty()) {
    ...
    if (productNo != null) {
        ...
        if (childClass == null) {
            ...
            childClass.getValue("Figure_Key").setSimpleValue("PS_" + productNo);
        ...
        log.info("Asset Referenct List Size: " + assetReferenceList.size());
        ...
        for (var i = 0; i < assetReferenceList.size(); i++) {
            ...
            log.info("Asset Class Array lenght: " + assetClassArray.length);
		  ...
		  var statusChangeReferences = assetObj.queryReferencedBy(referenceType);  //STEP-6396            
            ...
            statusChangeReferences.forEach(function(stChRefernceObj) {       //STEP-6396
                    ...
                    var searchValue = "PS_" + revisionName;
                    ...
                    if (lstFigureFolderClass != null) {
                        ...
                        if (typeof figureFolderObj !== 'undefined') {
                            ...
                            figureFolderObj.getValue("Figure_Key").setSimpleValue("PS_" + revisionName);
