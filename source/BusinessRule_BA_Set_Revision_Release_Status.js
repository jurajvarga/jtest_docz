...
{
  "id" : "BA_Set_Revision_Release_Status",
  "type" : "BusinessAction",
  "setupGroups" : [ "Product_Release" ],
  "name" : "BA_Set_Revision_Release_Status",
  "description" : null,
  "scope" : "Global",
...
*/
exports.operation0 = function (node,productReleased,productQueue,currentRevisionUpdated,baApproveProductObjects,baMigCatalogAttrFinal,manager,webCategoryQueue,baUpdateChildSpeciesHomology,busCondPublishProduct,baRepublish_Related_Kits,baRepublish_Related_Kits_Name,baResetAuditInstanceID,baSetRevRegEmailFlag,auditEventType,auditQueueMain,auditQueueApproved,pricingQueue,ItemPriceUpdated,baUpdatePublishDate,lookUp,mailHome,damPassthrough,damQueue,webDataRepublished,pricingQueueNPI,BA_ApproveRevisionObjects,BL_Approve,BL_AuditUtil,BL_CopyRevision,BL_CreateSKU,BL_InitPricing,BL_ReleaseCheck,bl_library) {
logger.info("Business Rule: BA_Set_Revision_Release_Status");
var rollbackChanges = false;

BL_ReleaseCheck.revisionRelease(node, productReleased, productQueue, currentRevisionUpdated, BA_ApproveRevisionObjects, baMigCatalogAttrFinal, manager, webCategoryQueue, //STEP-6465 BA_ApproveRevisionObjects
