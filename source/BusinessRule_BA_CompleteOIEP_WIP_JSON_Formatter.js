...
{
  "id" : "BA_CompleteOIEP_WIP_JSON_Formatter",
  "type" : "BusinessAction",
  "setupGroups" : [ "Outbound_WIP_Revision" ],
  "name" : "BA_CompleteOIEP_WIP_JSON_Formatter",
  "description" : null,
  "scope" : "Global",
...
Object.buildNodeMessage = function buildNodeMessage(node, simpleEventType) {
    ...
    if (prodCurRevnode) { //STEP-6396
        ...
        if (kit) {
            ...
            var kitRevskuReferences = prodCurRevnode.queryReferences(kitRevskuReferenceType); //STEP6396
...
executionReportLogger.logInfo(" objectType " + node.getObjectType().getID());
var mesgfinal;
