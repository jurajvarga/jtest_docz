...
{
  "id" : "BA_CreateSkuToUSCatalogReference",
  "type" : "BusinessAction",
  "setupGroups" : [ "Migration Business Actions" ],
  "name" : "BA_CreateSkuToUSCatalogReference",
  "description" : "Create SKU to catalog classification for US catalogs.",
  "scope" : "Global",
...
/**
script ID: BA_CreateSkuToUSCatalogReference
description: Create SKU to catalog classification for US catalogs.
...
var businessRule = "Business Rule: BA_CreateSkuToUSCatalogReference"
var currentObjectID = "Current Object ID: " + currentObject.getID();

// US Catalogs (object type: Catalog Region)
var class_home_id = "CR338408";
