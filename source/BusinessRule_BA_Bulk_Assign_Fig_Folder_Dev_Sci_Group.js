...
{
  "id" : "BA_Bulk_Assign_Fig_Folder_Dev_Sci_Group",
  "type" : "BusinessAction",
  "setupGroups" : [ "Bulk_Assign_WF4_App_Mgr_PC_Review" ],
  "name" : "BA Bulk Assign Fig Folder Dev Sci Group",
  "description" : "Webui Bulk Update rule for reassigning App Mgr PC Review, Dev_Sci_Review state",
  "scope" : "Global",
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "value" : "<AttributeValidatedContextParameter>\n  <Parameters>\n    <Parameter ID=\"Attribute\" Type=\"java.lang.String\">Dev_Sci_Group</Parameter>\n    <Parameter ID=\"ID\" Type=\"java.lang.String\">Dev_Sci_Group</Parameter>\n  </Parameters>\n</AttributeValidatedContextParameter>",
    "description" : null
  }, {
...
*/
exports.operation0 = function (Dev_Sci_Group,node,manager,auditEventType,auditQueueMain,auditQueueApproved,BL_AuditUtil,BL_Library,BL_MaintenanceWorkflows,BL_WorkflowUtil) {
var wfID = "WF4_App_Mgr_PC_Review_Workflow";
var stateID = "Dev_Sci_Review";
var userID = Dev_Sci_Group;
