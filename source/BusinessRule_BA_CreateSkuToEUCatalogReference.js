...
{
  "id" : "BA_CreateSkuToEUCatalogReference",
  "type" : "BusinessAction",
  "setupGroups" : [ "Migration Business Actions" ],
  "name" : "BA_CreateSkuToEUCatalogReference",
  "description" : "Create SKU to catalog classification for EU catalogs.",
  "scope" : "Global",
...
/**
script ID: BA_CreateSkuToEUCatalogReference
description: Create SKU to catalog reference for European catalogs.
...
var businessRule = "Business Rule: BA_CreateSkuToEUCatalogReference"
var currentObjectID = "Current Object ID: " + currentObject.getID();

// European Catalogs (object type: Catalog Customer)
var class_home_id = "CR338407";
